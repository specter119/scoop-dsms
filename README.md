...
| `anystorage` | Desktop client for S3-compatible storage, WebDAV, SFTP, and local files.<br>Version: `0.2.21`<br>[Homepage](https://anystorage.dev/) |
...
| `con-terminal` | The terminal emulator with AI harness, nothing more.<br>Version: `0.1.0-beta.82`<br>[Homepage](https://con.nowledge.co/) |
...
| `lody` | Manage all your code agents in one place.<br>Version: `0.77.1`<br>[Homepage](https://lody.ai/) |
...
| `multica` | The open-source managed agents platform. Turn coding agents into real teammates — assign tasks, track progress, compound skills.<br>Version: `0.4.22`<br>[Homepage](https://github.com/multica-ai/multica) |
...
| `vokie` | Vokie，立志做最快的AI语音输入法（西瓜说/Butter）<br>Version: `1.5.1`<br>[Homepage](https://xiguasay.com/) |
| `vscode-insiders-np` | Visual Studio Code is a lightweight but powerful source code editor (Insiders Edition).<br>Version: `1.133.0-5a36a9c68ce6300f94225aff5f8db533671af98b`<br>[Homepage](https://code.visualstudio.com/) |
