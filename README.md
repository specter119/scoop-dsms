...
| `anystorage` | Desktop client for S3-compatible storage, WebDAV, SFTP, and local files.<br>Version: `0.2.17`<br>[Homepage](https://anystorage.dev/) |
| `azurestorageexplorer` | Easily manage the contents of Azure storage account.<br>Version: `1.43.0`<br>[Homepage](https://azure.microsoft.com/en-us/features/storage-explorer/) |
...
| `con-terminal` | The terminal emulator with AI harness, nothing more.<br>Version: `0.1.0-beta.77`<br>[Homepage](https://con.nowledge.co/) |
...
| `cuda` | A parallel computing platform and programming model invented by NVIDIA.<br>Version: `13.3.0`<br>[Homepage](https://developer.nvidia.com/cuda-toolkit) |
| `cursor` | The AI-first code editor with powerful AI features for code completion, refactoring, and chat assistance.<br>Version: `3.7.21`<br>[Homepage](https://cursor.sh/) |
...
| `electron` | Build cross-platform desktop apps with JavaScript, HTML, and CSS.<br>Version: `42.3.3`<br>[Homepage](https://www.electronjs.org/) |
...
| `fzf` | A general-purpose command-line fuzzy finder<br>Version: `0.73.1`<br>[Homepage](https://github.com/junegunn/fzf) |
...
| `heptabase` | Heptabase is a visual note-taking app that helps you learn complex topics<br>Version: `1.98.0`<br>[Homepage](https://heptabase.com/) |
...
| `micromamba` | Micromamba is a tiny version of mamba, the fast conda package installer.<br>Version: `2.8.0-0`<br>[Homepage](https://github.com/mamba-org/mamba) |
...
| `multica` | The open-source managed agents platform. Turn coding agents into real teammates — assign tasks, track progress, compound skills.<br>Version: `0.3.18`<br>[Homepage](https://github.com/multica-ai/multica) |
| `note-gen` | A free and open source note-taking application.<br>Version: `0.28.0`<br>[Homepage](https://github.com/codexu/note-gen) |
...
| `podman` | A tool for managing OCI containers and pods.<br>Version: `5.8.2`<br>[Homepage](https://podman.io/) |
| `podman-tui` | Podman Terminal UI<br>Version: `1.11.1`<br>[Homepage](https://github.com/containers/podman-tui) |
| `qoderwork` | Qoder Work - AI-powered autonomous development workstation for real-world software engineering.<br>Version: `0.5.8`<br>[Homepage](https://qoder.com) |
| `qoderwork-cn` | Qoder Work CN - 为真实软件开发而生的智能体自主开发工作台<br>Version: `0.5.8`<br>[Homepage](https://qoder.com.cn) |
...
| `s3browser` | A freeware Windows client for Amazon S3 and Amazon CloudFront.<br>Version: `13.3.5`<br>[Homepage](https://s3browser.com/) |
...
| `spark` | A unified analytics engine for large-scale data processing.<br>Version: `4.1.0`<br>[Homepage](https://spark.apache.org/) |
...
| `typstyle` | A code formatter for Typst<br>Version: `0.14.4`<br>[Homepage](https://github.com/typstyle-rs/typstyle) |
...
| `vscode-insiders-np` | Visual Studio Code is a lightweight but powerful source code editor (Insiders Edition).<br>Version: `1.124.0-a9580a647dec55b4b8404365a7a63db201d9240f`<br>[Homepage](https://code.visualstudio.com/) |
...
| `yansu` | Yansu is a proactive AI agent that observes how you work and ships bespoke software on your behalf.<br>Version: `0.1.324`<br>[Homepage](https://yansu.ai) |
| `zeal` | An offline documentation browser for software developers<br>Version: `0.8.1`<br>[Homepage](https://zealdocs.org) |
| `zen-browser-optimized` | Experience tranquillity while browsing the web without people tracking you!<br>Version: `1.0.1-a.22`<br>[Homepage](https://zen-browser.app/) |

## Pinned Archive History

This section tracks manifests that have already been moved to `bucket/old`.

| Package | Version | Archived At | Reason |
| --- | --- | --- | --- |
