...
| `anystorage` | Desktop client for S3-compatible storage, WebDAV, SFTP, and local files.<br>Version: `0.2.15`<br>[Homepage](https://anystorage.dev/) |
...
| `con-terminal` | The terminal emulator with AI harness, nothing more.<br>Version: `0.1.0-beta.63`<br>[Homepage](https://con.nowledge.co/) |
| `confirmo` | A desktop pet developed for Claude Code users.<br>Version: `1.0.92`<br>[Homepage](https://github.com/yetone/confirmo-releases) |
| `cuda` | A parallel computing platform and programming model invented by NVIDIA.<br>Version: `13.2.1`<br>[Homepage](https://developer.nvidia.com/cuda-toolkit) |
| `cursor` | The AI-first code editor with powerful AI features for code completion, refactoring, and chat assistance.<br>Version: `3.2.21`<br>[Homepage](https://cursor.sh/) |
...
| `electron` | Build cross-platform desktop apps with JavaScript, HTML, and CSS.<br>Version: `42.0.0`<br>[Homepage](https://www.electronjs.org/) |
...
| `fzf` | A general-purpose command-line fuzzy finder<br>Version: `0.72.0`<br>[Homepage](https://github.com/junegunn/fzf) |
| `gsudo` | A Sudo for Windows<br>Version: `2.6.1`<br>[Homepage](https://gerardog.github.io/gsudo) |
| `heptabase` | Heptabase is a visual note-taking app that helps you learn complex topics<br>Version: `1.92.1`<br>[Homepage](https://heptabase.com/) |
...
| `micromamba` | Micromamba is a tiny version of mamba, the fast conda package installer.<br>Version: `2.6.0-0`<br>[Homepage](https://github.com/mamba-org/mamba) |
| `mpv` | Video player based on MPlayer/mplayer2 (builds by shinchiro) x86_64-v3 build<br>Version: `20260419-git-06f4ce7`<br>[Homepage](https://mpv.io) |
| `note-gen` | A free and open source note-taking application.<br>Version: `0.27.7`<br>[Homepage](https://github.com/codexu/note-gen) |
...
| `trae-cn` | Trae，致力于成为真正的 AI 工程师（The Real AI Engineer）。<br>Version: `2.3.21082`<br>[Homepage](https://www.trae.cn) |
...
| `vscode-insiders-np` | Visual Studio Code is a lightweight but powerful source code editor (Insiders Edition).<br>Version: `1.120.0-0aed0a9b6adcf8898b54afc1b9c28e3ac4e9c2d3`<br>[Homepage](https://code.visualstudio.com/) |
| `windsurf` | Windsurf is Codeium's next-generation AI IDE built to keep you in the flow.<br>Version: `2.1.32`<br>[Homepage](https://codeium.com/windsurf) |
