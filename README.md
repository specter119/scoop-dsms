...
| `con-terminal` | The terminal emulator with AI harness, nothing more.<br>Version: `0.1.0-beta.96`<br>[Homepage](https://con.nowledge.co/) |
...
| `cursor` | The AI-first code editor with powerful AI features for code completion, refactoring, and chat assistance.<br>Version: `3.19.13`<br>[Homepage](https://cursor.sh/) |
...
| `heptabase` | Heptabase is a visual note-taking app that helps you learn complex topics<br>Version: `1.108.2`<br>[Homepage](https://heptabase.com/) |
...
| `lody` | Manage all your code agents in one place.<br>Version: `0.92.1`<br>[Homepage](https://lody.ai/) |
...
| `multica` | The open-source managed agents platform. Turn coding agents into real teammates — assign tasks, track progress, compound skills.<br>Version: `0.4.41`<br>[Homepage](https://github.com/multica-ai/multica) |
...
| `spark` | A unified analytics engine for large-scale data processing.<br>Version: `4.2.0`<br>[Homepage](https://spark.apache.org/) |
...
| `tldraw-offline` | A desktop app for drawing, diagramming, and whiteboarding with local files.<br>Version: `1.16.0`<br>[Homepage](https://offline.tldraw.com/) |
...
| `vscode-insiders-np` | Visual Studio Code is a lightweight but powerful source code editor (Insiders Edition).<br>Version: `1.137.0-9aaf490382bd0ecdd72db3d2f308cdf1fdc6a79d`<br>[Homepage](https://code.visualstudio.com/) |
...
| `yansu` | Yansu is a proactive AI agent that observes how you work and ships bespoke software on your behalf.<br>Version: `0.1.353`<br>[Homepage](https://yansu.ai) |
| `zeal` | An offline documentation browser for software developers<br>Version: `0.9.1`<br>[Homepage](https://zealdocs.org) |
